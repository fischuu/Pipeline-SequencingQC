...
snakemake -s /scratch/project_2001310/Pipeline-SequencingQC/Pipeline-SequencingQC.smk \
          -j 200 \
          --latency-wait 60 \
          --use-singularity \
          --singularity-args "-B /scratch:/scratch,/projappl:/projappl" \
          --configfile /scratch/project_2001310/Pipeline-SequencingQC/Pipeline-SequencingQC_config.yaml \
          --cluster-config /scratch/project_2001310/Pipeline-SequencingQC/Pipeline-SequencingQC_server-config.yaml \
